    ...
    <section class="content">
        ...
        <div class="row">
            ...
            EDIT JABATAN
                ...
                <?php echo form_open('bagian/edit-proses/'.$value->id_bagian,['class'=>'form-horizontal style-form']); ?>
				<table class="table table-bordered">
					<tr class="success"><th colspan="2">JABATAN</th></tr>
					<tr><td width="150">Nama Jabatan</td>
                            <td>
							<div class="col-sm-6">
                                  <input name="nama_bagian" type="text" id="no_induk" class="form-control" value="<?php echo $value->bagian; ?>" placeholder="Nama Bagian" required />
                              </div>
                    </td></tr>
