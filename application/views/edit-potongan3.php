    ...
    <section class="content">
        ...
        <div class="row">
            ...
            EDIT POTONGAN
                ...
                <?php echo form_open('potongan/edit-proses3/'.$value->id_alpha,['class'=>'form-horizontal style-form']); ?>
				<table class="table table-bordered">
					<tr class="success"><th colspan="2">POTONGAN</th></tr>
					<tr><td width="150">Tidak Masuk Sehari</td>
                            <td>
							<div class="col-sm-6">
                                  <input name="potongan_alpha" type="number" id="nama" class="form-control" value="<?php echo $value->potongan_alpha; ?>" placeholder="Gaji Pokok Bagian" required />
                            </div>
                    </td></tr>
				</table>
